...
<link href="<?php echo e(PUBLIC_PATH); ?>/css/plugins/dataTables/datatables.min.css" rel="stylesheet">
<link href="<?php echo e(PUBLIC_PATH); ?>/css/animate.css" rel="stylesheet">
<link href="<?php echo e(PUBLIC_PATH); ?>/css/plugins/awesome-bootstrap-checkbox/awesome-bootstrap-checkbox.css" rel="stylesheet">
<link href="<?php echo e(PUBLIC_PATH); ?>/css/plugins/bootstrap-tagsinput/bootstrap-tagsinput.css" rel="stylesheet">
<link href="<?php echo e(PUBLIC_PATH); ?>/css/plugins/daterangepicker/daterangepicker-bs3.css" rel="stylesheet">
<link href="<?php echo e(PUBLIC_PATH); ?>/css/plugins/datapicker/datepicker3.css" rel="stylesheet">
<link href="<?php echo e(PUBLIC_PATH); ?>/css/plugins/steps/jquery.steps.css" rel="stylesheet">
<link href="<?php echo e(PUBLIC_PATH); ?>/css/style.css" rel="stylesheet">
<link href="<?php echo e(PUBLIC_PATH); ?>/css/custom.css" rel="stylesheet">
...
<div class="sidebar-collapse">
    <ul class="nav metismenu" id="side-menu">
        <li class="nav-header">
            <div class="dropdown profile-element">
                ...
                <ul class="dropdown-menu animated fadeInRight m-t-xs">
                    ...
                    <li><a class="dropdown-item" href="<?php echo e(route('dang-xuat')); ?>">Logout</a></li>
                </ul>
            </div>
        ...
        <li>
            <a href="<?php echo e(route('')); ?>"><i class="fa fa-th-large"></i> <span class="nav-label">Trang chủ</span></a>
        </li>
        <?php if(isAdmin()): ?>
        <li class="">
            ...
            <ul class="nav nav-second-level collapse" aria-expanded="false" style="height: 0px;">
                <li><a href="<?php echo e(route('mon-hoc')); ?>">Quản lý môn học</a></li>
                <li><a href="<?php echo e(route('mon-hoc/tao-moi')); ?>">Tạo mới môn học</a></li>
            </ul>
        </li>
        <?php endif; ?>
        <?php if(isAdmin()): ?>
        <li class="">
            ...
            <ul class="nav nav-second-level collapse" aria-expanded="false" style="height: 0px;">
                <li><a href="<?php echo e(route('mon-hoc/quizs')); ?>">Quản lý quiz</a></li>
                <li><a href="<?php echo e(route('mon-hoc/quizs/tao-moi')); ?>">Tạo mới quiz</a></li>
            </ul>
        </li>
        <?php endif; ?>
        <?php if(isAdmin()): ?>
        <li>
            <a href="<?php echo e(route('nguoi-dung')); ?>"><i class="fas fa-users"></i> <span class="nav-label">Người dùng</span></a>
        </li>
        <?php endif; ?>
        <?php if(isAdmin()): ?>
        <li>
            <a href="<?php echo e(route('thong-ke')); ?>"><i class="fas fa-chart-area"></i> <span class="nav-label">Thống kê</span></a>
        </li>
        <?php endif; ?>
        <?php if(!isAdmin()): ?>
        <li>
            <a href="<?php echo e(route('lich-su')); ?>"><i class="fas fa-history"></i> <span class="nav-label">Lịch sử</span></a>
        </li>
        <?php endif; ?>
        <!-- <li>
...
<div class="wrapper wrapper-content"><?php /**PATH C:\xampp\htdocs\PHP2_THAYTHIEN\ASM_QUIZ\app\views/blocks/header.blade.php ENDPATH**/ ?>