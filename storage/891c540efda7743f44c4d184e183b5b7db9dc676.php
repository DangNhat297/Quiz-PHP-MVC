            ...
            <?php $__currentLoopData = $questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="panel panel-primary">
                    <div class="panel-heading font-weight-bold">
                        <h3>Câu hỏi: <?php echo e($question->name); ?></h3>
                        <?php if($question->img != 'null' && $question->img != '' && $question->img != null): ?>
                            <img style="display:block;max-width:150px;margin:10px 0" referrerpolicy="no-referrer" src="<?php echo e($question->img); ?>">
                        <?php endif; ?>
                    </div>
                    <div class="panel-content">
                        <ul class="todo-list">
                            <?php $__currentLoopData = $question->answers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $answer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li><span class="font-weight-bold"><?php echo e($answer->content); ?></span>
                                ...
                                <?php if($answer->img != 'null' && $answer->img != '' && $answer->img != null): ?>
                                    <img src="<?php echo e($answer->img); ?>" referrerpolicy="no-referrer" style="display:block;max-width:150px;margin:10px 0;">
                                <?php endif; ?>
                            </li>
                    ...
                    <div class="panel-footer">
                        <button class="btn btn-primary edit-question" data-question-id="<?php echo e($question->id); ?>" data-toggle="modal" data-target="#edit-question"><i class="far fa-edit"></i></button>
                        <button class="btn btn-danger delete-question" data-question-id="<?php echo e($question->id); ?>"><i class="far fa-trash-alt"></i></button>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#add-question').submit(function(e) {
            ...
            $.ajax({
                url: '<?php echo e(route("api/question")); ?>',
                type: 'POST',
                dataType: 'json',
                data: $data,
                contentType: false,
        ...
        $('.delete-question').click(function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '<?php echo e(route("api/question/")); ?>' + $id,
                        type: 'DELETE',
                        dataType: 'json',
                        success: function(response) {
                            if (response.status == 'success') {
        ...
        $('#update-question').submit(function(e){
            ...
            $.ajax({
                url: '<?php echo e(route("api/question/")); ?>' + $idQuestion,
                type: 'POST',
                dataType: 'json',
                data: $data,
                contentType: false,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\PHP2_THAYTHIEN\ASM_QUIZ\app\views/QuizDetail.blade.php ENDPATH**/ ?>