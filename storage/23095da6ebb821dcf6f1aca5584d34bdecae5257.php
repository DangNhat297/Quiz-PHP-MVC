...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '.edit-subject', function() {
            ...
            $.ajax({
                url: '<?php echo e(route("api/subject/")); ?>' + $id,
                type: 'GET',
                dataType: 'json',
                success: function(response) {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\PHP2_THAYTHIEN\ASM_QUIZ\app\views/ListSubject.blade.php ENDPATH**/ ?>